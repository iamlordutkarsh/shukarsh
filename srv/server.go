...
func (s *Server) setUpDatabase(dbPath string) error {
	...
	// Auto-seed: if products table has fewer than the 20 seeded products, re-run seed
	var count int
	if err := wdb.QueryRow("SELECT COUNT(*) FROM products").Scan(&count); err == nil && count < 20 {
